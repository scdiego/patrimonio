...
public class FrmCargo extends javax.swing.JDialog {
    ...
    private Asignacion getAsignacionFromForm() {
        //BienJpaController bienDao = new BienJpaController(); 
        //int nroInventario = Integer.parseInt(txtNroInventario.getText());
        //List<Bien> bienes = bienDao.findBienByNroInventario(nroInventario);
        //Bien bien = bienes.get(0);
        Responsable resp = (Responsable) lstResponsable.getSelectedItem();
        Responsable subResp = (Responsable) lstSubResponsable.getSelectedItem();
