...
public class MainFormOld extends javax.swing.JFrame {
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        FrmBuscarBienes ventana = new FrmBuscarBienes(this,rootPaneCheckingEnabled);
        ventana.setUser(this.getUser());
        mostrarVentana(ventana);    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainFormOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainFormOld().setVisible(true);
            }
        });
    }
